    ...
    <div>
        ...
        <header>
            ...
            <div className="header-legend">
                <div className="header-wrapper">
                    <h2>Paginas web en Mexicali, desarrollo de Aplicaciones, y Marketing digital.</h2>
                </div>
            </div>
        </header>
        <main>
            <div className="body-wrapper">
                ...
                <footer>
                    <div className="footer-item last"><b>Azulacero, agencia interactiva.</b> <span>©2016-{new Date().getFullYear()} Algunos derechos reservados.</span></div>
